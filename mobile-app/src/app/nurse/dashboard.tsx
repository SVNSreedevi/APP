...
export default function NurseDashboard() {
  ...
  const firstName = user?.fullName ? user.fullName.split(' ')[0] : 'Nurse';
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.headerCard}>
          <View style={styles.headerTextContainer}>
            <Text style={styles.greetingText}>{greeting}, Nurse {firstName} 👋</Text>
          ...
          <TouchableOpacity 
            ...
            onPress={() => router.push('/nurse/start-surgery')}
          >
        ...
        <View style={styles.sectionContainer}>
          ...
          {stats.criticalPatients.length > 0 ? (
            stats.criticalPatients.map(p => (
              <TouchableOpacity key={p._id} style={styles.criticalCard} onPress={() => router.push(`/nurse/patients/${p._id}` as any)}>
                ...
                <View style={styles.vitalsRow}>
                  ...
                  <View style={styles.vitalItem}>
                    ...
                    <Text style={[styles.vitalValue, { color: '#34d399' }]}>112/70</Text>
                  </View>
                  <View style={styles.vitalItem}>
        ...
        <View style={styles.quickActionsGrid}>
          <TouchableOpacity style={styles.actionBtn} onPress={() => router.push('/nurse/patients')}>
            <FontAwesome5 name="user-injured" size={24} color="#94a3b8" />
            <Text style={styles.actionText}>Patients</Text>
          </TouchableOpacity>
          
          <TouchableOpacity style={styles.actionBtn} onPress={() => router.push('/nurse/profile')}>
            <FontAwesome5 name="user-nurse" size={24} color="#94a3b8" />
...
const styles = StyleSheet.create({
  ...
  dateText: {
    color: '#6ee7b7', // emerald-300 equivalent
    fontSize: 14,
  },
  newSurgeryBtn: {
    flexDirection: 'row',
